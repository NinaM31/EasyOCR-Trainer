...
def validation(model, criterion, evaluation_loader, converter, opt, device):
    ...
    f1 = f1_score(labels, preds_str, average='micro')
    accuracy = n_correct / float(length_of_data) * 100
    norm_ED = norm_ED / float(length_of_data) # ICDAR2019 Normalized Edit Distance

    return valid_loss_avg.val(), accuracy, f1, norm_ED, preds_str, confidence_score_list, labels, infer_time, length_of_data
